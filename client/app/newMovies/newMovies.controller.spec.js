...
describe('Controller: newMoviesController', function () {
  ...
  it('should show right error when query timedout', function(){
  	httpBackend.when("GET", "https://omdbapi.com/?s=the&y=2016").respond({});
  	scope.getFilms();
