...
describe('Controller: searchController', function () {
  ...
  it('should show right error when query timedout', function(){
  	httpBackend.when("GET", "https://omdbapi.com/?s=ab").respond({});
  	scope.searchM="ab";
  	scope.submit();
